...
DEPLOYED_URL = 'https://cloudwars2functionapp.azurewebsites.net/api/UpdateProfile?code=OI65ObiLE2GyMRLJnwwHUtyLEqC/aSFaSGdAORbSvH2owvLL/pvraw=='
...
update_dict = {'first': 'Yemma',
 'middle': 'dD',
 'last': 'Aldifort',
 'fulldate': '1998-01-01',
 'social': '',
 'phone': '+1 2424 444 444',
 'address_1': '',
 'address_2': '',
 'city': '',
 'state': 'NM',
...
def main(account_id, update_dict):
    ...
    return update_profile(account_id, update_dict)


main(account_id, update_dict)