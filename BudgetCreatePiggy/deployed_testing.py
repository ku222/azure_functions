...
card.add([
    ...
    ColumnSet(),
        Column(width=1),
            "<",
        Column(width=5),
            TextBlock(text="Type in a name for your Piggy Bank", color="light"),
            InputText(ID="name", placeholder="Unique Name"),
            RichTextBlock(spacing="small"),
                TextRun(text="Eg. ", color="light"),
                TextRun(text="Savings, Holidays, Rainy Day", color="accent"),
                "<",
